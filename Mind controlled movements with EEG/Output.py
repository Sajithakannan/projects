...
MODEL_NAME = "C:\\Users\\saji\\OneDrive\\Desktop\\BCI Model\\90.81-acc-64x3-batch-norm-1epoch-1708442622-loss-0.23.h5"  # your model path here. 

model = tf.keras.models.load_model(MODEL_NAME)
reshape = (-1, 16, 60)
model.predict( np.zeros((32,16,60)).reshape(reshape) )

ACTION = "D:\\College\\Mini Project\\model_data\\validation_data\\left"  # THIS IS THE ACTION YOU'RE THINKING 
...
for i in range(TOTAL_ITERS):  # how many iterations. Eventually this would be a while True
    ...
    if BOX_MOVE == "random":
    ...
    elif BOX_MOVE == "D:\\College\\Mini Project\\model_data\\validation_data\\left":
        ...
        if choice == 0:
            ...
            if ACTION == "D:\\College\\Mini Project\\model_data\\validation_data\\right":
                correct += 1
            square['x1'] += MOVE_SPEED
            square['x2'] += MOVE_SPEED
            right += 1
            ...
            if ACTION == "D:\\College\\Mini Project\\model_data\\validation_data\\none":
                correct += 1
            none += 1
...
datadir = "D:\\College\\Mini Project\\model_data\\data"
...
for action in ["D:\\College\\Mini Project\\model_data\\data\\left", 
               "D:\\College\\Mini Project\\model_data\\validation_data\\right", 
               "D:\\College\\Mini Project\\model_data\\validation_data\\none"]:
